/*
 *  程序名：  crtsurfdata.cpp  本程序用于生成全国气息站点观测的分钟数据。 
*/
...
int main(int argc,char *argv[])
{
  ...
  if ( (argc != 5) && (argc != 6) )
  {
    ...
    printf("Example:/project/idc2/bin/crtsurfdata /project/idc2/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv 20220312184400\n\n");
    printf("	/project/idc2/bin/crtsurfdata /project/idc2/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv 20220312211000\n");
    printf("	/project/tools1/bin/procctl 60 /project/idc2/bin/crtsurfdata /project/idc2/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata.log xml,json,csv\n\n\n");
...
void CrtSurData()
{
  ...
  for (int ii = 0;ii < vstcode.size();ii++)
  {
    ...
    stsurfdata.p = rand()%265+10000;//气压：单位 0.1千帕
...
bool CrtSurfFile(const char *outpath,const char *datafmt)
{
  //拼接生成数据的文件名，例如：SURF_ZH_20220210160800_2254.csv
