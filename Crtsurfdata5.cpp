/*
 *  程序名：  crtsurfdata5.cpp  本程序用于生成全国气息站点观测的分钟数据。 
*/
...
int main(int argc,char *argv[])
{
  ...
  if (argc != 5)
  {
    ...
    printf("Example:/project/idc2/bin/crtsurfdata5 /project/idc2/ini/stcode.ini /tmp/idc/surfdata /log/idc/crtsurfdata5.log xml,json,csv\n\n");
