/* 
 *  程序名：xmltodb.cpp，本程序是数据中心的公共功能模块，用于把xml文件入库到MySQL表中。
 *  作者：李响。
 */
#include "_tools.h"
