/*
 *  obtmindtodb.cpp，本程序用于把全国站点分钟观测数据保存入库T_ZHOBTMIND表中，支持xml和csv两种格式。
 *  作者：李响。
*/
#include "idcapp.h"
...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools1/bin/procctl 10 /project/idc2/bin/obtmindtodb /idcdata/surfdata \"127.0.0.1,root,Lx2022,mysql,3306\" utf8 /log/idc/obtmindtodb.log\n\n");
  ...
  PActive.AddPInfo(30,"obtmindtodb");  // 进程的心跳，30妙足够。
  // 注意，在调试程序的时候，可以启用类似以下的代码，防止超时。
  // PActive.AddPInfo(5000,"obtmindtodb");

  // 业务处理主函数。
  _obmindtodb(argv[1],argv[2],argv[3]);
