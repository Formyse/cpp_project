...
int main(int argc,char *argv[])
{
  ...
  if (argc!=5)
  {
    ...
    printf("Example:/project/tools1/bin/procctl 120 /project/idc2/bin/obtcodetodb /project/idc/ini/stcode.ini \"127.0.0.1,root,Lx2022,mysql,3306\" utf-8 /log/idc/obtcodetodb.log\n\n");
  ...
  PActive.AddPInfo(10,"obtcodetodb");  // 进程的心跳，10妙足够。
  ...
  stmtins.prepare("insert into T_ZHOBTCODE(obtid,cityname,provname,lat,lon,height,upttime) value(:1,:2,:3,:4*100,:5*100,:6*10,now())");
